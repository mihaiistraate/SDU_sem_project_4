...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {U0}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {U1}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {D1}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {D2}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {B0}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {B1}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {B2}];  # "JA9"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {S0A}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {S0B}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {S1A}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {S1B}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {S2A}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {S2B}];  # "JB8"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {LED_U0}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {LED_U1}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {LED_D1}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {LED_D2}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {LED_B0}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {LED_B1}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {LED_B2}];  # "LD6"
